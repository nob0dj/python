...
def scrape_webtoon():
    ...
    print(
        btn_sort_by_star)  # <selenium.webdriver.remote.webelement.WebElement (session="f3243061b252598683e639c2caca6778", element="67b371e3-d843-49de-89a4-bca0fe77f900")>
...
# schedule.every().minute.do(scrape_webtoon)
schedule.every().day.at('00:10').do(scrape_webtoon)
